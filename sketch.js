...
function draw() {
 ...
 background("white");
     ...
     if (World.frameCount % 80 == 0) {
       if (select_obs== 1) {
        ...
        if(count===100){
          ...
          ob1G.setLifetimeEach(0);
          ob2G.setLifetimeEach(0);
          ob3G.setLifetimeEach(0);
          ob4G.setLifetimeEach(0);
          ob5G.setLifetimeEach(0);
          ob6G.setLifetimeEach(0);
  ...
  textSize(45);
  fill("black");
  text("GET 100 SCORE TO",10,400);
  text(" WIN!!!",80,470);

  textSize(30);
  text(" Press left key for moving the car left",1000,200);
  text(" Press right key for moving the car right",975,250);
}
function Obs1() {
